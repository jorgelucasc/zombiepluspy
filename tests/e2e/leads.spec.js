...
test('não deve cadastrar com email inválido', async ({ page }) => {
  await page.landing.visit()
  await page.landing.openLeadModal()
  await page.landing.submitLeadForm('Jorge Lucas','lucashotmail.com')
...
test('não deve cadastrar sem email', async ({ page }) => {
  await page.landing.visit()
  await page.landing.openLeadModal()
  await page.landing.submitLeadForm('Jorge Lucas','')
...
test('não deve cadastrar sem nome', async ({ page }) => {
  await page.landing.visit()
  await page.landing.openLeadModal()
  await page.landing.submitLeadForm('','lucas@hotmail.com')
